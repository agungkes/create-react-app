...
```sh
npx create-react-app my-app --typescript --scripts-version=guan-react-scripts
cd my-app
npm start
```
...
```sh
npm init react-app my-app --typescript --scripts-version=guan-react-scripts
```
...
```sh
yarn create react-app my-app --typescript --scripts-version=guan-react-scripts
```
