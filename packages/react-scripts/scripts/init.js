...
module.exports = function(
    ...
    console.log(
        chalk.cyan(`
        Sedang melakukan pemasangan ${additionalDependencies.join(
            ', '
    ...
    console.log(
        chalk.cyan(
            "Dont't forget to add bootstrap.native, reactstrap, and bootstrap in your project ^^"
        )
    );
};
